...
## [0.1.19](https://github.com/ArnavJain23/openinference/compare/python-openinference-instrumentation-anthropic-v0.1.18...python-openinference-instrumentation-anthropic-v0.1.19) (2025-07-30)
...
* **anthropic:** add tool json schema attributes to anthropic instrumentation ([#1087](https://github.com/ArnavJain23/openinference/issues/1087)) ([907b6e5](https://github.com/ArnavJain23/openinference/commit/907b6e530cb3ded377e99a7cbe7de1f35f55d39f))
...
* add tool id for anthropic instrumentor and serialize `content` to string if it's not a string ([#1129](https://github.com/ArnavJain23/openinference/issues/1129)) ([682724c](https://github.com/ArnavJain23/openinference/commit/682724ce436ef8ece5d821073e3845cc3a9d602d))
* capture anthropic model name from response ([#1124](https://github.com/ArnavJain23/openinference/issues/1124)) ([8e915f2](https://github.com/ArnavJain23/openinference/commit/8e915f2589764575dea0771284c4ecf3182460ec))
...
* remove anthropic dependency ([#1094](https://github.com/ArnavJain23/openinference/issues/1094)) ([4dd0bba](https://github.com/ArnavJain23/openinference/commit/4dd0bba7687f7ab70e0cb973ac588a850a9e99b2))
